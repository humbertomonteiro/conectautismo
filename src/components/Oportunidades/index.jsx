      ...
      >
        <div className={styles.boxes}>
          <div className={styles.firstBox} data-aos="zoom-in">
            ...
            <p>
              Mergulhe no universo do autismo com o Conect Autismo. Este evento
              é uma janela para o mundo do TEA, oferecendo insights profundos
              através de apresentações de especialistas de renome internacional.
              Explore as mais recentes descobertas, terapias inovadoras e
              abordagens progressivas que estão moldando o futuro do autismo
            </p>
          </div>
          <div className={styles.box} data-aos="zoom-in">
            ...
            <p>
              Participar do Conect Autismo significa ter acesso a um arsenal de
              recursos valiosos. Desde terapias de vanguarda e técnicas de apoio
              até informações cruciais sobre serviços e organizações dedicadas
              ao TEA, tudo ao seu alcance. É uma oportunidade única para
              enriquecer seu conhecimento e rede de apoio.
            </p>
          </div>
          <div className={styles.box} data-aos="zoom-in">
            ...
            <p>
              ...
              Autismo é um catalisador para o crescimento profissional. Atualize
              suas habilidades, absorva novas abordagens terapêuticas e
        ...
        <div className={styles.boxes}>
          ...
          <div className={styles.box} data-aos="zoom-in">
            ...
            <h3>Ações Sociais</h3>
            <p>
              Compromisso Social e Transformação: Conect Autismo & Casa Ronald
              McDonald Um Passo Adiante na Solidariedade. Com cada ingresso
              vendido para o Conect Autismo, não apenas avançamos na educação e
              conscientização sobre o autismo, mas também abraçamos uma causa
              maior. Uma parte de cada ingresso é destinada ao Casa Ronald
              McDonald, e é com orgulho que compartilhamos nossa validação como
              doadores.
